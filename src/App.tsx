  ...
  useEffect(() => {
    ...
    const checkOTA = async (force = false) => {
      ...
      try {
        ...
        console.error('🏮 OTA Silent Error:', err);
      } finally {
        isChecking.current = false;
        setShowSplash(false); // LUÔN VÀO APP DÙ CÓ LỖI GÌ
      }
    };
